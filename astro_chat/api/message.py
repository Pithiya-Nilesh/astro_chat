...
from astro_chat.utils import update_room, is_user_allowed_in_room, raise_not_authorized_error
...
def mark_as_read(room: str):
    ...
    """
    frappe.enqueue(
        "astro_chat.utils.update_room", room=room, is_read=1, update_modified=False
    )
